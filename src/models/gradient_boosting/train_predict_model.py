...
# keeping conn_src_adr_for_dst_adr_count gives an accuracy of 100% with 100% feature importance
df.drop(['Label', 'Dst IP', 'Src IP', 'Start Time', 'End Time', 'Tot Bytes', 'Tot Pkts', 'conn_src_adr_for_dst_adr_count'], axis=1, inplace=True)
...
pickle.dump(gb, open('./random_forest_model.sav', 'wb'))
